...
# remark !!! 123456  11 12 13 , 17 ,18

# Initialize a Flask app to host the events adapter
app = Flask(__name__)

# let us preform actions
# Initialize a Web API client
slack_web_client = WebClient(os.environ.get("SLACKBOT_TOKEN"))

# read messages and decode them ,liesen to every thing
# the message comes incripted , decode them , and sends them to "slack web client"
